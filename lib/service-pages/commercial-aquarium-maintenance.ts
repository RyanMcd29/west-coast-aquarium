...
export const commercialAquariumMaintenancePage: ServicePage = {
  ...
  summary: "Presentation-first care with flexible scheduling for businesses.",
  keywords: [
  ...
  faqs: [
    {
      ...
      answer: "Yes. We can arrange early, late, or weekend visits where needed.",
    },
    {
    ...
    },
    {
      ...
      answer: "Yes. We support multi-site scheduling across Perth metro.",
    },
  ],
};

export default commercialAquariumMaintenancePage;
